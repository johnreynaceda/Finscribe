                ...
                <div x-data="{ open: false }">
                    ...
                    <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false" style="display: none;">
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('stakeholder.expense.sub-category') }}" title="#"
                                    class="{{ request()->routeIs('stakeholder.expense.sub-category') ? 'bg-white text-main scale-95' : '' }} inline-flex items-center w-full p-2 pl-3 text-sm font-light text-gray-400 rounded-lg hover:text-main group hover:bg-gray-50">
                                    <span class="inline-flex items-center w-full">
                                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                ...
                <div x-data="{ open: false }">
                    ...
                    <div class="p-2 pl-6 -px-px" x-show="open" @click.outside="open = false"
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="{{ route('stakeholder.budgeting') }}" title="#"
                                    class="{{ request()->routeIs('stakeholder.budgeting') ? 'bg-white text-main scale-95' : '' }} inline-flex items-center w-full p-2 pl-3 text-sm font-light text-gray-400 rounded-lg hover:text-main group hover:bg-gray-50">
                                    <span class="inline-flex items-center w-full">
                                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
                                        ...
                                        <span class="ml-4">Budgeting Report </span>
                                    </span>
                                </a>
                            </li>
                            <li>
                                <a href="{{ route('stakeholder.budgeting-category') }}" title="#"
                                    class="{{ request()->routeIs('stakeholder.budgeting-category') ? 'bg-white text-main scale-95' : '' }} inline-flex items-center w-full p-2 pl-3 text-sm font-light text-gray-400 rounded-lg hover:text-main group hover:bg-gray-50">
                                    <span class="inline-flex items-center w-full">
                                        <svg width="15" height="15" viewBox="0 0 15 15" fill="none"
                                            xmlns="http://www.w3.org/2000/svg">
                                            <path
